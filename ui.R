  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "overview", 
              ...
              fluidRow(column(6, h5(align = "left", "Tested = number of people performed covid-19 test"),
                              h5(align = "left", "Infected = number of people tested positive of covid-19"),
                              h5(align = "left", "Deaths = number of people died of covid-19 infection")),
                       column(6, h5(align = "right", "Tested Ratio = tested/population"),
                              h5(align = "right", "Infected Ratio = infected/tested"),
                              h5(align = "right", "Fatality Ratio = death/tested"))),
